...
describe("GamePage", () => {
  ...
  it("shows_a_completed_game_summary_with_rating_changes_and_review_cta", async () => {
    mockApi.getGame
      ...
      .mockResolvedValue({
        ...
        result: { winner: "white", reason: "checkmate" },
        rating_snapshot: {
          overall: { white_before: 1500, white_after: 1516, black_before: 1342, black_after: 1326 },
          specific: { white_before: 1508, white_after: 1524, black_before: 1317, black_after: 1301 },
          white_track: "vs_bots",
  ...
  it("uses_engine_material_summary_when_available", async () => {
    ...
    expect(within(blackMaterialView).getByText("2")).toBeInTheDocument()
  })
