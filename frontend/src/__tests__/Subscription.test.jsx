...
describe("SubscriptionPage", () => {
  it("renders_the_tier_table_and_mounts_embedded_checkout_for_the_selected_plan", async () => {
    ...
    expect(screen.getAllByRole("link", { name: "Random Bot" })[0]).toHaveAttribute("href", "/user/randobot")
    expect(screen.getAllByRole("link", { name: "Simple Heuristics Bot" })[0]).toHaveAttribute("href", "/user/simpleheuristics")
    expect(screen.getAllByRole("link", { name: "Stockfish Wild 16" })[0]).toHaveAttribute("href", "/user/stockfishwild")
