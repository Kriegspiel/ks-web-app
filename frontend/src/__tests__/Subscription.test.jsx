...
describe("SubscriptionPage", () => {
  ...
  it("renders_the_tier_table_and_mounts_embedded_checkout_for_the_selected_plan", async () => {
    ...
    expect(within(botCells[2]).getByText("T2 DeepSeek:")).toBeInTheDocument()
    expect(within(botCells[2]).getByRole("link", { name: "V3.2" })).toHaveAttribute("href", "/user/llm_deepseek_v32")
    ...
    expect(within(botCells[2]).getByText("T2 Qwen:")).toBeInTheDocument()
    expect(within(botCells[2]).getByRole("link", { name: "Plus" })).toHaveAttribute("href", "/user/llm_qwen_plus")
    expect(within(botCells[2]).getByRole("link", { name: "3.7 Plus" })).toHaveAttribute("href", "/user/llm_qwen37_plus")
    expect(within(botCells[2]).getByText("T2 MiniMax:")).toBeInTheDocument()
    expect(within(botCells[2]).getByRole("link", { name: "M3" })).toHaveAttribute("href", "/user/llm_minimax_m3")
    ...
    expect(within(botCells[3]).getByRole("link", { name: "GPT-5.6 Luna (reasoning: no)" })).toHaveAttribute("href", "/user/llm_gpt56_luna")
    ...
    expect(within(botCells[3]).queryByText("T3 xAI:")).not.toBeInTheDocument()
    ...
    expect(within(botCells[3]).getByRole("link", { name: "3.5 Flash" })).toHaveAttribute("href", "/user/llm_gemini35_flash")
    ...
    expect(within(botCells[3]).getByRole("link", { name: "Medium 3.5" })).toHaveAttribute("href", "/user/llm_mistral_medium35")
    ...
    expect(within(botCells[3]).queryByRole("link", { name: "Plus" })).not.toBeInTheDocument()
    ...
    expect(within(botCells[4]).getByRole("link", { name: "GPT-5.6 Terra (reasoning: no)" })).toHaveAttribute("href", "/user/llm_gpt56_terra")
    ...
    expect(within(botCells[5]).getByRole("link", { name: "GPT-5.6 Sol (reasoning: no)" })).toHaveAttribute("href", "/user/llm_gpt56_sol")
    expect(within(botCells[5]).getByRole("link", { name: "GPT-5.5 (reasoning: no)" })).toHaveAttribute("href", "/user/llm_gpt55")
    ...
    expect(within(botCells[5]).getByText("T5 xAI:")).toBeInTheDocument()
    expect(within(botCells[5]).getByRole("link", { name: "Grok 4.5" })).toHaveAttribute("href", "/user/llm_grok45")
    expect(within(botCells[5]).getByRole("link", { name: "3.7 Max" })).toHaveAttribute("href", "/user/llm_qwen37_max")
    ...
    expect(customLlmCells[5]).toHaveTextContent("New LLM providers and modes; fully customizable prompts and conversation strategies.")
    expect(customLlmCells[6]).toHaveTextContent("New LLM providers and modes; fully customizable prompts and conversation strategies.")
