...
describe("SubscriptionPage", () => {
  ...
  it("renders_the_tier_table_and_mounts_embedded_checkout_for_the_selected_plan", async () => {
    ...
    expect(within(botCells[3]).getByText("Default reasoning level: none")).toBeInTheDocument()
    ...
    expect(within(botCells[4]).getByText("Default reasoning level: none")).toBeInTheDocument()
    ...
    expect(within(botCells[5]).getByRole("link", { name: "GPT-5.5 Pro" })).toHaveAttribute("href", "/user/llm_gpt55_pro")
    expect(within(botCells[5]).getAllByText("Default reasoning level: none")).toHaveLength(2)
    expect(within(botCells[5]).getByText("Default reasoning level: medium")).toBeInTheDocument()
